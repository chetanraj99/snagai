"""
Django settings for sangai project.
...
SECRET_KEY = 'django-insecure-1hv*b+d6&ru2a8%9tpqz(xsl!tk0i-5z6)at3*lgl(9!=2@akn'
...
WSGI_APPLICATION = 'sangai.wsgi.application'
